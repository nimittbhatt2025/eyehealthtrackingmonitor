...
function Community() {
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900">Community</h1>
        <p className="text-sm md:text-base text-gray-600 mt-2">Welcome to EyeVio - Your Vision Health Platform</p>
      </div>

      {/* Welcome Message */}
      <div className="bg-gradient-to-r from-[#7dcab9] to-[#a39c85] rounded-2xl p-6 md:p-8 text-white">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
        <div className="flex items-start space-x-4 mb-6">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#7dcab9] to-[#a39c85] rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl flex-shrink-0">
            E
          </div>
          <div className="flex-1">
      ...
      {/* Coming Soon */}
      <div className="bg-gradient-to-r from-[#f3f0e9] to-white rounded-2xl p-6 md:p-8 border border-gray-200">
        <h2 className="text-xl md:text-2xl font-serif font-bold text-gray-900 mb-3">Community Features Coming Soon</h2>
